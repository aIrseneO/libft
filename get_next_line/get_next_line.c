...
/*   Updated: 2021/01/11 03:31:15 by atemfack         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				get_next_line(int fd, char **line)
{
	...
	n = gnl_extract_line(fd, buffer, line, reste);
	if (gnl_free(n, buffer, &reste) < 1)
		return (n);
	n = gnl_clean_line(line, &reste);
	if (n == -1)
